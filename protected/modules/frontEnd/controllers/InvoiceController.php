...
//        $dataProvider->criteria->params[':branch_id'] = Yii::app()->user->branch_id;
    ...
    public function actionAjaxHtmlUpdateRegistrationTable() {
        if (Yii::app()->request->isAjaxRequest) {
            ...
            $registrationTransaction = Search::bind(new RegistrationTransaction('search'), isset($_POST['RegistrationTransaction']) ? $_POST['RegistrationTransaction'] : '');
            $registrationTransactionDataProvider = $registrationTransaction->searchByInvoice();
            $registrationTransactionDataProvider->criteria->with = array(
                'customer',
                'vehicle',
...
//            $dataProvider->criteria->params[':branch_id'] = Yii::app()->user->branch_id;
    ...
    public function actionAjaxHtmlUpdateInvoiceTable() {
        if (Yii::app()->request->isAjaxRequest) {
            
            $model = Search::bind(new InvoiceHeader('search'), isset($_POST['InvoiceHeader']) ? $_POST['InvoiceHeader'] : '');
            $dataProvider = $model->search();
            $dataProvider->criteria->with = array(
                'customer',
                'vehicle',
...
//            $dataProvider->criteria->params[':branch_id'] = Yii::app()->user->branch_id;
            ...
            $this->renderPartial('_invoiceDataTable', array(
                'model' => $model,
                'dataProvider' => $dataProvider,
                'customerName' => $customerName,
                'plateNumber' => $plateNumber,
