        ...
        <tbody>
            <?php foreach ($dataProvider->data as $data): ?>
                <tr>
                    ...
                    <td><?php echo CHtml::encode(CHtml::value($data, 'feedback')); ?></td>
                    <td>
                        <?php echo CHtml::link('<i class="bi-plus"></i>Feedback', array("updateFeedback", "id" => $data->id), array('class' => 'btn btn-success btn-sm')); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
