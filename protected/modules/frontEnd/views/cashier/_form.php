        ...
        <fieldset class="border border-secondary rounded mb-3 p-3">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <?php echo CHtml::activeDropDownlist($paymentIn->header, 'company_bank_id', CHtml::listData(CompanyBank::model()->findAllByAttributes(array('company_id' => 7, 'status' => 'Active'), array('order' => 'account_name')), 'id', 'accountNameAndNumber'), array(
