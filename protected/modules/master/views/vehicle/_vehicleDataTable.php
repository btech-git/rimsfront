        ...
        <tbody>
            <?php foreach ($vehicleDataProvider->data as $vehicle): ?>
                <tr>
                    ...
                    <td>
                        <?php echo CHtml::link('<i class="bi-search"></i>', array("view", "id" => $vehicle->id), array('class' => 'btn btn-info btn-sm')); ?>
                        <?php echo CHtml::link('<i class="bi-pencil"></i>', array("update", "id" => $vehicle->id), array('class' => 'btn btn-warning btn-sm')); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
