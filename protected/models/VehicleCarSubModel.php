...
/**
 * This is the model class for table "rims_vehicle_car_sub_model".
 *
 * The followings are the available columns in table 'rims_vehicle_car_sub_model':
 * @property integer $id
...
class VehicleCarSubModel extends CActiveRecord
{
	...
	{
		return 'rims_vehicle_car_sub_model';
	}
	...
	public function rules()
	{
		...
		return array(
			array('car_make_id, car_model_id, name, user_id, created_datetime', 'required'),
			array('car_make_id, car_model_id, is_approved, user_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, car_make_id, car_model_id, name, is_approved, user_id, created_datetime', 'safe', 'on'=>'search'),
		);
	}
