...
/**
 * This is the model class for table "rims_bank".
 *
 * The followings are the available columns in table 'rims_bank':
 * @property integer $id
...
class Bank extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'paymentIns' => array(self::HAS_MANY, 'PaymentIn', 'bank_id'),
		);
	}
