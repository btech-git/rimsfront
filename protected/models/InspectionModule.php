...
/**
 * This is the model class for table "rims_inspection_module".
 *
 * The followings are the available columns in table 'rims_inspection_module':
 * @property integer $id
 ...
 * @property InspectionSectionModule[] $inspectionSectionModules
 */
class InspectionModule extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'inspectionSectionModules' => array(self::HAS_MANY, 'InspectionSectionModule', 'module_id'),
		);
	}
