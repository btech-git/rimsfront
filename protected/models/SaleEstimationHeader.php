...
/**
 * This is the model class for table "rims_sale_estimation_header".
 *
 * The followings are the available columns in table 'rims_sale_estimation_header':
 * @property integer $id
...
class SaleEstimationHeader extends MonthlyTransactionActiveRecord {
    ...
    public function tableName() {
        return 'rims_sale_estimation_header';
    }
    ...
    public function rules() {
        ...
        return array(
            array('transaction_number, transaction_date, transaction_time, repair_type, status, created_datetime, branch_id, user_id_created', 'required'),
            ...
            array('sub_total, sub_total_service, discount_price_service, total_price_service, sub_total_product, discount_price_product, total_price_product, grand_total, tax_product_amount, tax_service_amount', 'length', 'max' => 18),
            ...
            array('id, transaction_number, transaction_date, transaction_time, repair_type, problem, total_quantity_service, sub_total, sub_total_service, discount_price_service, total_price_service, total_quantity_product, sub_total_product, discount_price_product, total_price_product, grand_total, status, vehicle_mileage, note, created_datetime, edited_datetime, customer_id, vehicle_id, branch_id, user_id_created, user_id_edited, employee_id_sale_person, tax_product_percentage, tax_product_amount, tax_service_percentage, tax_service_amount', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'tax_product_percentage' => 'Tax Product Percentage',
            'tax_product_amount' => 'Tax Product Amount',
    ...
    public function search() {
        ...
        $criteria->compare('tax_product_percentage', $this->tax_product_percentage, true);
        $criteria->compare('tax_product_amount', $this->tax_product_amount, true);
    ...
    public function searchByOutstanding() {
        ...
        $criteria->addCondition("NOT EXISTS (
            SELECT r.sale_estimation_header_id
            FROM " . RegistrationTransaction::model()->tableName() . " r
            WHERE t.id = r.sale_estimation_header_id AND r.status NOT LIKE '%CANCEL%'
