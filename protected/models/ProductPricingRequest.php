...
/**
 * This is the model class for table "rims_product_pricing_request".
 *
 * The followings are the available columns in table 'rims_product_pricing_request':
 * @property integer $id
...
class ProductPricingRequest extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, recommended_price, request_date, quantity, user_id_request, user_id_reply, extension, reply_date, request_time, reply_time, request_note, reply_note, branch_id_request, branch_id_reply, product_name, vehicle_car_make_id, production_year, brand_id, product_master_category_id, sub_brand_id, sub_brand_series_id, product_sub_master_category_id, product_sub_category_id, vehicle_car_model_id', 'safe', 'on' => 'search'),
        );
    }
