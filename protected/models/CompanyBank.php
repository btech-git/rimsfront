...
/**
 * This is the model class for table "rims_company_bank".
 *
 * The followings are the available columns in table 'rims_company_bank':
 * @property integer $id
...
class CompanyBank extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'paymentIns' => array(self::HAS_MANY, 'PaymentIn', 'company_bank_id'),
        );
    }
