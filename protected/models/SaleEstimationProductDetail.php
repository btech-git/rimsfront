...
/**
 * This is the model class for table "rims_sale_estimation_product_detail".
 *
 * The followings are the available columns in table 'rims_sale_estimation_product_detail':
 * @property integer $id
...
class SaleEstimationProductDetail extends CActiveRecord {
    ...
    public function tableName() {
        return 'rims_sale_estimation_product_detail';
    }
