...
/**
 * This is the model class for table "rims_sale_estimation_service_detail".
 *
 * The followings are the available columns in table 'rims_sale_estimation_service_detail':
 * @property integer $id
...
class SaleEstimationServiceDetail extends CActiveRecord {
    ...
    public function tableName() {
        return 'rims_sale_estimation_service_detail';
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, price, discount_value, discount_type, memo, sale_estimation_header_id, service_id, service_type_id, total_price', 'safe', 'on' => 'search'),
        );
    }
