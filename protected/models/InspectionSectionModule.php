...
/**
 * This is the model class for table "rims_inspection_section_module".
 *
 * The followings are the available columns in table 'rims_inspection_section_module':
 * @property integer $id
...
class InspectionSectionModule extends CActiveRecord
{
	...
	{
		return 'rims_inspection_section_module';
	}
