...
/**
 * This is the model class for table "rims_inspection_sections".
 *
 * The followings are the available columns in table 'rims_inspection_sections':
 * @property integer $id
...
class InspectionSections extends CActiveRecord
{
	...
	{
		return 'rims_inspection_sections';
	}
