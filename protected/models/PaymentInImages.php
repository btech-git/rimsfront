...
/**
 * This is the model class for table "rims_payment_in_images".
 *
 * The followings are the available columns in table 'rims_payment_in_images':
 * @property integer $id
